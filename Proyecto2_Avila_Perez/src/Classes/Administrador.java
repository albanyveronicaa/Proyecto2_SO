...
public class Administrador extends Thread {
    ...
    public Administrador(){
        ...
        updateColasUi();
        System.out.println("cola numero 1 de Star Trek: " + this.startrekColaNivel1.print());
        System.out.println("cola numero 2 de Star Trek: " + this.startrekColaNivel2.print());
        System.out.println("cola numero 3 de Star Trek: " + this.startrekColaNivel3.print());
        System.out.println("cola numero 1 de Star Wars: " + this.starwarsColaNivel1.print());
        System.out.println("cola numero 2 de Star Wars: " + this.starwarsColaNivel2.print());
        System.out.println("cola numero 3 de Star Wars: " + this.starwarsColaNivel3.print());
        this.ia = Main.ia;
    ...
    private void creacionColas() {
        ...
        this.colaStarwarsUi1 = GlobalUi.getMainPage().getColaLamboUi1();
        this.colaStarwarsUi2 = GlobalUi.getMainPage().getColaLamboUi2();
        this.colaStarwarsUi3 = GlobalUi.getMainPage().getColaLamboUi3();
        this.colaStarwarsUiRef = GlobalUi.getMainPage().getColaLamboUiRef();
        
        this.colaStartrekUi1 = GlobalUi.getMainPage().getColaBgUi1();
        this.colaStartrekUi2 = GlobalUi.getMainPage().getColaBgUi2();
        this.colaStartrekUi3 = GlobalUi.getMainPage().getColaBgUi3();
        this.colaStartrekUiRef = GlobalUi.getMainPage().getColaBgUiRef();
    }
    ...
    public void run(){
        try {
            while(this.running){
                ...
                GlobalUi.getMainPage().getUiLamboId().setText(("Star Wars - " + starwars.getId()));
                GlobalUi.getMainPage().getUiBugattiId().setText(("Star Trek - " + startrek.getId()));
                GlobalUi.getMainPage().setCarsImgsUi();
                // actualizar HP y calidad en interfaz
                GlobalUi.getMainPage().getCalidadLamboUi().setText(Integer.toString((int) starwars.getCalidadFinal()));
                GlobalUi.getMainPage().getCalidadBgUi().setText(Integer.toString((int) startrek.getCalidadFinal()));
                GlobalUi.getMainPage().getLamboHP().setText(Integer.toString(starwars.getCaballosFuerza()));
                GlobalUi.getMainPage().getBugattiHP().setText(Integer.toString(startrek.getCaballosFuerza()));
