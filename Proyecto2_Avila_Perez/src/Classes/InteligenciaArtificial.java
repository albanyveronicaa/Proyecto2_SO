...
public class InteligenciaArtificial extends Thread {
                ...
                if(this.personaStarwars == null || this.personaStartrek == null){
                    ...
                    if(decision <= 40){ //hay ganador
                        ...
                        if(winner.getSerie().equals("Starwars")){ 
                            ...
                            GlobalUi.getMainPage().getLamboWinsLabel().setText(Integer.toString(starwarsWins));
                            //decir que gano
                            GlobalUi.getMainPage().getLamboWinnerLabel().setText("Ganador!");
                            
                        }else if(winner.getSerie().equals("starwars")){                           
                            this.startrekWins++;
                            GlobalUi.getMainPage().getBugattiWinsLabel().setText(Integer.toString(startrekWins));
    ...
    public Personaje decideWinner(){
        ...
        if(Math.abs(personaStarwars.getCaballosFuerza() - personaStartrek.getCaballosFuerza()) <= 50){
    ...
    public Personaje winnerByHP(){
        ...
        if(personaStarwars.getCaballosFuerza() > personaStartrek.getCaballosFuerza()){
            //lambo tiene mas HP
            winner = this.personaStarwars;
        }else if (personaStarwars.getCaballosFuerza() < personaStartrek.getCaballosFuerza()){
            winner = this.personaStartrek;
